...
public class DBHelper {
    ...
    public DBHelper(ServerConfig serverConfig) {
        this.config = serverConfig;
    }
    public Connection getConnectionByZk() {
        Connection coon = null;
        try {
            coon = DriverManager.getConnection(config.getDbUrl(),config.getDbUser(), config.getDbPwd());
